package com.example.emodiary.UI.diary;
...
import com.example.emodiary.databinding.FragmentDiaryBinding;
import com.example.emodiary.models.Note;
                    ...
                    public void onClick(final View v) {
                        ...
                        menu.getMenu().add("Edit").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                Intent i = new Intent(v.getContext(), EditDiary.class);
                                i.putExtra("title",note.getTitle());
                                i.putExtra("content",note.getContent());
                                i.putExtra("noteId",docId);
                                EditDiary n = new EditDiary();
                                Navigation.findNavController(getView()).navigate(R.id.nav_to_editNote);
                                return false;
                            }
                        });
